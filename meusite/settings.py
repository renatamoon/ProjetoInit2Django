...
SECRET_KEY = 'django-insecure-4#r989f5n%s6e-$s2_ylxd%=edx#l#wk4$#r%a+o(74qs57h^c'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True  #DEIXA PORQUE O DJANGO ASSUME QUE AINDA ESTAMOS EM PROCESSO DE CRIAÇÃO
